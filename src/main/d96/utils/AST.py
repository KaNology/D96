...
#     def __str__(self):
#         return "For(" + str(self.id) + "," + str(self.expr1) + "," + str(self.expr2) + "," + str(self.loop) + ("," + str(self.expr3) if self.expr3 else "") + ")"
...
#     def __str__(self):
#         return "MethodDecl(" + str(self.kind) + ',' + str(self.name) + ",[" + ','.join(i.toParam() for i in self.param) + "]," + str(self.body) + ")"
